<?php 
	...
	if(isset($_POST) & !empty($_POST)){
		...
		$sql = "UPDATE products SET name='$prodname', description='$description', categoryid='$category', price='$price',thumbneil='$filepath' WHERE id = $id";
		 ...
		 <?php 	
			...
			<form method="post" enctype="multipart/form-data">
			  <div class="form-group">
			  	<input type="hidden" name="filepath" value="<?php echo $r['thumbneil']; ?>">
			  ...
			  <div class="form-group">
				...
				?>
					<option value="<?php echo $catr['id']; ?>" <?php if( $catr['id'] == $r['categoryid']){ echo "selected"; } ?>><?php echo $catr['categoryname']; ?></option>
				<?php } ?>
				</select>
			  </div>
			  ...
			  <div class="form-group">
			    ...
			    <br>
			    <?php if(isset($r['thumbneil']) & !empty($r['thumbneil'])){?>
			    <img src="<?php echo $r['thumbneil']?>" width="100px" height="100px">
